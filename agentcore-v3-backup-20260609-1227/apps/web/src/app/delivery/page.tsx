...
export default function DeliveryPage() {
 ...
 <h1 className="heading-2 text-[var(--text)] mb-3">Доставка и оплата</h1>
  <p className="text-sm text-[var(--text-muted)] mb-10">Как получить доступ к сервису и оплатить подписку. Последнее обновление: 2026-06-01</p>
 ...
 <li>Платформа готова к работе — начинайте использовать сразу</li>
  ...
  <p>Первые 7 дней — пробный период, без ограничений и без привязки карты.</p>
  ...
  <span className="text-3xl font-bold text-[var(--brand)]">₽2 900</span>
 ...
 <li>Система быстрых платежей (СБП)</li>
  ...
  <p>Платежи обрабатываются через ЮKassa. Все платёжные данные передаются по защищённому соединению (HTTPS/TLS) и не хранятся на наших серверах.</p>
