  ...
  return (
    <>
      <div className="p-6 lg:p-10 max-w-7xl mx-auto">
        ...
        <motion.div variants={container} initial="hidden" animate="show" className="mb-10">
          <motion.div variants={item} className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-mauve-600 text-white text-sm font-semibold hover:bg-mauve-700 transition-all duration-200 shadow-sm shadow-mauve-600/10 focus-visible:ring-2 focus-visible:ring-mauve-500 focus-visible:ring-offset-1"
            ...
            <div className="flex flex-col">
              <div className={`flex items-center gap-3 bg-white rounded-xl border p-3 ${urlError ? 'border-red-300' : 'border-mauve-100'}`}>
                ...
                <input
                  ...
                  className="flex-1 bg-transparent text-sm text-ink-900 placeholder-ink-400 outline-none focus-visible:ring-2 focus-visible:ring-[var(--brand,theme(colors.mauve.500))] focus-visible:ring-offset-1 rounded"
                />
                <button
          ...
          <motion.div variants={item} initial="hidden" animate="show" className="mb-6">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-11 pr-4 py-2.5 bg-white rounded-xl border border-mauve-100 shadow-sm text-sm text-ink-900 placeholder-ink-400 focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--brand,theme(colors.mauve.500))] focus-visible:ring-offset-1 transition-all duration-200"
              />
            </div>
          </motion.div>
        )}
        ...
        <motion.div variants={container} initial="hidden" animate="show" className="mb-10">
          <h2 className="font-display font-semibold text-lg text-ink-900 mb-4">Документы</h2>
