    ...
    <div className="min-h-screen bg-[#F8F9FB]">
      <div className="max-w-3xl mx-auto px-5 py-16">
        ...
        <div className="prose prose-sm max-w-none text-ink-600 space-y-6">
          ...
          <h2 className="text-lg font-semibold text-ink-900 mt-10 mb-3">1. Какие данные мы собираем</h2>
          ...
          <h2 className="text-lg font-semibold text-ink-900 mt-10 mb-3">2. Как мы используем данные</h2>
          ...
          <h2 className="text-lg font-semibold text-ink-900 mt-10 mb-3">3. Хранение данных</h2>
          ...
          <h2 className="text-lg font-semibold text-ink-900 mt-10 mb-3">4. Передача данных третьим лицам</h2>
          ...
          <h2 className="text-lg font-semibold text-ink-900 mt-10 mb-3">5. Ваши права</h2>
          <ul className="list-disc pl-5 space-y-1">
          ...
          <p>Для реализации этих прав напишите на <a href="mailto:privacy@agentcore.work" className="text-mauve-600 underline">privacy@agentcore.work</a>.</p>

          <h2 className="text-lg font-semibold text-ink-900 mt-10 mb-3">6. Cookies</h2>
          ...
          <h2 className="text-lg font-semibold text-ink-900 mt-10 mb-3">7. Изменения политики</h2>
          ...
          <h2 className="text-lg font-semibold text-ink-900 mt-10 mb-3">8. Контакты</h2>
          <p>По вопросам конфиденциальности: <a href="mailto:privacy@agentcore.work" className="text-mauve-600 underline">privacy@agentcore.work</a></p>
          <p>Адрес: г. Алматы, Казахстан</p>
          <p className="text-xs text-ink-500 bg-mauve-50 border border-mauve-200 p-3 rounded-lg mt-4">
