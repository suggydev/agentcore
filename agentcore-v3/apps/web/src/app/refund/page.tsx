    ...
    <div className="min-h-screen bg-[#F8F9FB]">
      <div className="max-w-3xl mx-auto px-5 py-16">
        ...
        <div className="prose prose-sm max-w-none text-ink-600 space-y-6">
          ...
          <h2 className="text-lg font-semibold text-ink-900 mt-10 mb-3">2. Бесплатный пробный период</h2>
          ...
          <h2 className="text-lg font-semibold text-ink-900 mt-10 mb-3">3. Гарантия возврата</h2>
          ...
          <ol className="list-decimal pl-5 space-y-1">
            <li>Написать на <a href="mailto:billing@agentcore.work" className="text-mauve-600 underline">billing@agentcore.work</a> с темой «Возврат средств»</li>
          ...
          <h2 className="text-lg font-semibold text-ink-900 mt-10 mb-3">4. Сроки возврата</h2>
          ...
          <h2 className="text-lg font-semibold text-ink-900 mt-10 mb-3">5. Случаи, когда возврат не производится</h2>
          ...
          <h2 className="text-lg font-semibold text-ink-900 mt-10 mb-3">6. Частичный возврат</h2>
