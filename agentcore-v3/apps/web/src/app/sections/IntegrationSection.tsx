        ...
        <div className="grid md:grid-cols-3 gap-6">
          {CHANNELS.map((channel, i) => (
            <motion.div
              ...
              className="bg-[var(--bg)] rounded-xl p-6 border border-[var(--border)]"
            >
              <div className="flex items-center gap-3 mb-6">
                <span className="text-2xl">{channel.icon}</span>
                <div>
                  <h3 className="font-semibold text-[var(--text)]">{channel.name}</h3>
                  <div className="text-xs text-[var(--text-muted)]">{channel.time}</div>
                </div>
              </div>
