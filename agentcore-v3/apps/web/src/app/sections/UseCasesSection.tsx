        ...
        >
          {USE_CASES.map((useCase, i) => (
            <motion.div
              ...
              className="p-7 rounded-[10px] bg-white shadow-inset"
            >
              ...
              <div className="flex flex-col gap-2">
                <div className="self-end text-[13px] px-3 py-2 rounded-xl rounded-br-sm max-w-[85%] bg-midnight text-white leading-relaxed">
                  {useCase.chat.user}
                </div>
                <div className="self-start text-[13px] px-3 py-2 rounded-xl rounded-bl-sm max-w-[85%] leading-relaxed text-charcoal" style={{ background: 'var(--brand-light)' }}>
                  {useCase.chat.agent}
                </div>
              </div>
            </motion.div>
