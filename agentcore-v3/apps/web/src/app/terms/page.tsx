...
export default function TermsPage() {
 ...
 .catch(err => { console.error('[TermsPage] Failed to load settings:', err); setFetchError('Не удалось загрузить данные. Проверьте подключение.'); });
 }, []);
...
<div className="max-w-3xl mx-auto px-5 py-16">
 ...
 <p className="text-sm text-[var(--text-muted)] mb-10">Публичная оферта. Последнее обновление: {lastUpdated}</p>
 ...
 <p>5.3. Для запроса возврата необходимо написать на <a href="mailto:billing@agentcore.work" className="text-[var(--brand)] underline">billing@agentcore.work</a>.</p>
