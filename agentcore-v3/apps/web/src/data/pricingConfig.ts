...
export const PLAN_CARDS: PlanCard[] = [
 ...
 btnClass: 'bg-[var(--bg)] text-[var(--text-muted)] border border-[var(--border)] cursor-not-allowed',
 scale: '',
 },
 {
 id: 'pro',
 ...
 btnDisabled: false,
 btnIcon: Sparkles,
 accentColor: 'border-[var(--accent)] shadow-lg ',
...
export const UPGRADE_PLANS: UpgradePlan[] = [
 ...
 topBarGradient: 'from-[var(--brand)] to-[var(--brand)]',
 btnClass: 'bg-[var(--accent)] text-white hover:bg-[var(--accent)] shadow-sm ',
 },
 {
 id: 'enterprise',
 name: 'Enterprise',
